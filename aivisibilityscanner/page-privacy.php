<?php
/**
 * Privacy page — auto-loaded for slug "privacy".
 *
...
<div class="page-content">
    <div class="container">
        ...
        <p>AI Visibility Scanner is committed to minimal data collection. Here&rsquo;s exactly what we collect and why.</p>

        <h2>What the Scanner Collects</h2>
        <p>When you use the public AI Scanner at aivisibilityscanner.com:</p>
        <ul>
        ...
        <p>The AnswerEngineWP WordPress plugin (available separately at answerenginewp.com) operates entirely on your server. It does not send data to our servers unless you explicitly use the public scanner or a feature that requires an API call (such as AI Summary Generation in the Pro tier). When API calls are made, only the page content necessary for analysis is transmitted.</p>
        ...
        <h2>Contact</h2>
        <p>Questions about this policy: <a href="mailto:hello@aivisibilityscanner.com">hello@aivisibilityscanner.com</a></p>
    </div>
</div>
</main>
