<?php
/**
 * Badge page — auto-loaded for slug "badge".
 *
...
<div class="page-content">
    <div class="container">
        ...
        <h2>How It Works</h2>
        <ol>
            <li>Scan your site at <a href="<?php echo esc_url( home_url( '/scanner/' ) ); ?>">aivisibilityscanner.com</a></li>
...
<pre><code>&lt;a href="https://aivisibilityscanner.com/report/YOUR_HASH"
   title="AI Visibility Score &mdash; Verified by AI Visibility Scanner"
   style="display:inline-block;text-decoration:none"&gt;
  &lt;img src="/wp-json/aivs/v1/badge/YOUR_HASH.svg"
