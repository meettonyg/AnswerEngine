...
add_action( 'wp_head', function() use ( $title ) {
	echo '<meta property="og:title" content="' . esc_attr( $title ) . ' &middot; AnswerEngineWP">' . "\n";
	...
	<div class="container">
		...
		<div class="leaderboard-table">
			...
			<div class="<?php echo esc_attr( $row_class ); ?>">
				...
				<span class="leaderboard-row__domain"><?php echo esc_html( $entry['domain'] ); ?></span>
		...
		<div class="leaderboard-page__methodology">
			<p>Rankings based on AnswerEngineWP structural AI visibility analysis. Scores reflect extractability signals, not endorsement or traffic.</p>
		</div>
	</div>
</section>
</main>
