<section class="pricing section">
    <div class="container">
        <div class="fade-up">
            ...
            <h2 class="section-heading">Priced as an add-on, not a replacement.</h2>
            <p class="pricing__sub">Your existing SEO plugin costs ~$99/year. AnswerEngineWP sits alongside it — not on top of it.</p>
        </div>
